...
public class Macronutrients_CustomAdapter extends RecyclerView.Adapter<Macronutrients_CustomAdapter.MacronutrientsViewHolder> {
    ...
    private Activity activity_macronutrients;
    private ArrayList macro_id, macro_protein, macro_fat, macro_carbs, macro_fibre, macro_salt;

    public Macronutrients_CustomAdapter(Context context, Activity activity, ArrayList macro_id,
