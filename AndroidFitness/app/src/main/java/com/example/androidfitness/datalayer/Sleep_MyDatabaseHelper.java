...
public class Sleep_MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    public Sleep_MyDatabaseHelper(@Nullable Context context) {
    ...
    public void addSleep(String date, int totalSleep, int deepSleep) {
    ...
    public void updateSleepData(String row_id, String date, String totalSleep, String deepSleep) {
    ...
    public void deleteRowSleep(String row_id) {
