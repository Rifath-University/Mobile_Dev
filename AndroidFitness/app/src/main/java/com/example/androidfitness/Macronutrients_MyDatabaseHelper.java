...
public class Macronutrients_MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    Macronutrients_MyDatabaseHelper(@Nullable Context context) {
    ...
    void addMacronutrients(int protein, int fat, int carbohydrates, int fibre, int salt) {
    ...
    Cursor macronutrientsReadAllData() {
    ...
    void updateMacroData(String row_id, String protein, String fat, String carbohydrates, String fibre, String salt) {
    ...
    void deleteRowMacro(String row_id) {
