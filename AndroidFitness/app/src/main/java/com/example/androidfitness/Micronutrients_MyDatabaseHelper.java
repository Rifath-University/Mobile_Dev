...
public class Micronutrients_MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    Micronutrients_MyDatabaseHelper(@Nullable Context context) {
    ...
    void addMicronutrients(float vitb, float vitc, float vite, float magnesium, float zinc) {
    ...
    void updateMicroData(String row_id, String vitb, String vitc, String vite, String magnesium, String zinc) {
    ...
    void deleteRowMicro(String row_id) {
