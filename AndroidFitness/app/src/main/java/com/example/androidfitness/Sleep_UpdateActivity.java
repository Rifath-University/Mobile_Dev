...
public class Sleep_UpdateActivity extends AppCompatActivity {
    ...
    EditText sleep_date_input_update, sleep_totalSleep_input_update, sleep_deepSleep_input_update;
    Button sleep_update_button, sleep_delete_button;
    String id, date, totalSleepUpdate, deepSleepUpdate;
